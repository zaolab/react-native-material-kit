...
import { Animated, TextInput, View, NativeModules, findNodeHandle, } from 'react-native';
...
class FloatingLabel extends Component {
    ...
    render() {
        ...
        return (<Animated.Text ref="label" pointerEvents="none" allowFontScaling={this.props.allowFontScaling} style={[{
...
FloatingLabel.propTypes = Object.assign({}, FloatingLabel.publicPropTypes, { 
    // internal props
    tintColor: PropTypes.string, highlightColor: PropTypes.string, opacityAniDur: PropTypes.number });
...
class Underline extends Component {
    ...
    renderUnderline() {
        return this.props.underlineEnabled && (<Animated.View style={{
            position: 'absolute',
...
class Textfield extends Component {
    ...
    render() {
        ...
        if (this.props.floatingLabelEnabled) {
            // the floating label
            const props = Object.assign(pick(['tintColor', 'highlightColor', 'floatingLabelFont'], tfTheme), utils.extractProps(this, FloatingLabel.propTypes));
            floatingLabel = (<FloatingLabel ref="floatingLabel" {...props} text={this.props.placeholder} allowFontScaling={this.props.allowFontScaling}/>);
        }
        const underlineProps = Object.assign(pick(['tintColor', 'highlightColor'], tfTheme), utils.extractProps(this, ['tintColor',
            'highlightColor', 'underlineSize', 'underlineEnabled']));
        const inputProps = utils.extractProps(this, Object.assign({}, TextInput.propTypes, { password: 1 }));
        return (<View style={this.props.style} onLayout={this._doMeasurement.bind(this)}>
        {floatingLabel}
        <TextInput // the input
         ref="input" {...inputProps} {...this.props.additionalInputProps} style={[{
                backgroundColor: MKColor.Transparent,
                alignSelf: 'stretch',
                paddingTop: 2,
                paddingBottom: 2,
        ...
        ]} onChangeText={this._onTextChange} onFocus={this._onFocus} onBlur={this._onBlur} allowFontScaling={this.props.allowFontScaling} secureTextEntry={this.props.password} underlineColorAndroid="transparent"/>
        <Underline ref="underline" // the underline
         {...underlineProps} underlineAniDur={this.props.floatingLabelAniDuration}/>
      </View>);
    }
}
// ## <section id='props'>Props</section>
Textfield.propTypes = Object.assign({}, TextInput.propTypes, { 
    // Alias to `value`
    text: PropTypes.string, 
    // alias to `onChangeText`
    onTextChange: PropTypes.func, 
    // Alias to `secureTextEntry`
    password: PropTypes.bool }, FloatingLabel.publicPropTypes, { 
